          ...
          <div class="col-sm-12 mb-sm-0">
            <div class="card">
              <div class="card-body">
                ...
                <button data-bs-toggle="modal" data-bs-target="#modalChangePassword" class="btn btn-outline-primary btn-sm">更改</button>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content rounded-4 shadow">
        <div class="modal-header p-5 pb-4 border-bottom-0">
          <h1 class="fw-bold mb-0 fs-2">更改密码</h1>
...
<script>
  $('.PasswordArea').on('submit',function(e){
      ...
      var ans = GetTextByAJAX("/manage/account/changepassword.exe?" + md5(Old) + "+" + md5(New));
