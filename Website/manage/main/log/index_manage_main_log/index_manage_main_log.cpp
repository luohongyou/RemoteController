...
int main(int argc, char* argv[])
{
    ...
    <div class="portfolio-info">
        ...
        <ul class="nav nav-underline">
          <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#basic-pane" role="tab">基础</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#advanced-pane" role="tab">高级</a>
          </li>
        </ul>
    ...
    <script>
        ChangeTextByAJAX("basiclog", "/manage/main/log/logdisplayer.exe?1");
        ChangeTextByAJAX("websitelog", "/manage/main/log/logdisplayer.exe?2");
        ChangeTextByAJAX("agentlog", "/manage/main/log/logdisplayer.exe?3");
