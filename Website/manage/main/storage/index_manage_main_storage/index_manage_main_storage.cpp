...
int main(int argc, char* argv[])
{
    ...
    LONGLONG All, Temp, Screenshoot, UpdatePack;
    All = get_folder_size("..\\..\\");
    Temp = get_folder_size("temp");
    Screenshoot = get_folder_size("screenshoot\\cache");
...
<div class="row gy-4">
  <div class="col-lg-8">
    <div class="portfolio-info">
      ...
      <p>用户截图产生的图片。<br>大小：)" + size2string(Screenshoot) + R"(
  ...
  <div class="col-lg-4">
    ...
    <script>
        ChangeTextByAJAX("storagelist", "/manage/main/storage/liststorage.exe");
        function Clean(ID)
        {
          swal({
            title: "清空存储",
