...
int main(int argc, char* argv[])
{
    ...
    <div class="portfolio-info">
        ...
        <ul class="nav nav-underline">
          <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#now-pane" role="tab">实时剪贴板</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#history-pane" role="tab">历史剪贴板</a>
          </li>
        </ul>
    ...
    <script>
        ...
        {
            ChangeTextByAJAX("clipboardall", "/clipboard/getclipboardhistory.exe");
        }
        function RefreshAll()
        {
            RefreshNow();
