...
int main()
{
    ...
    // screenshoot
    CreateDirectoryA((ReleaseFolder + "screenshoot").c_str(), NULL);
    CreateDirectoryA((ReleaseFolder + "screenshoot\\cache").c_str(), NULL);
    RCCopyFileA("index_screenshoot.exe", (ReleaseFolder + "screenshoot\\index.exe").c_str(), false);
    RCCopyFileA("printscreen.exe", (ReleaseFolder + "screenshoot\\printscreen.exe").c_str(), false);
    RCCopyFileA("screenshootlist.exe", (ReleaseFolder + "screenshoot\\screenshootlist.exe").c_str(), false);
    RCCopyFileA("screenshootdelete.exe", (ReleaseFolder + "screenshoot\\screenshootdelete.exe").c_str(), false);
