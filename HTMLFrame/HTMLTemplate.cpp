...
{
	std::string TranslatedLink, InnerScript = "";
...
<head>
  ...
  <title>)" + BrowserTitle + R"( - Coral Remote Controller</title>
...
#endif
+ R"(
  <footer id="footer" style="background-image: url(/assets/img/background.jpg?300); background-size:100%; background-repeat:no-repeat; background-position:center;">
      <div>
	    <center>
			<br>
			<h4 style="color:white"> Coral Remote Controller </h2>
			<h5 style="color:white"> 版本 )" + VERSION + R"( </h4>
			<p style="color:white"> Copyright &copy; 2020 - 2024 Coral Studio. All Rights Reserved. </p>
			<br>
	    </center>
	  </div>
  </footer><!-- End Footer -->
